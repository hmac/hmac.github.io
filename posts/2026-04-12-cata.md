...
In the [last post](https://hmac.dev/posts/2025-11-09-eliminating-case-expressions.html) I incorrectly said that the case eliminator for the List type was fold. Of course it isn’t, the type of `fold(r)` is
```
b -> (a -> b -> b) -> List a -> b
```
