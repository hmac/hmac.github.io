...
(function($PS) {
  ...
  var SelectRule = (function () {
      function SelectRule(value0) {
          this.value0 = value0;
      };
      SelectRule.create = function (value0) {
          return new SelectRule(value0);
      };
      return SelectRule;
  })();
  var ApplyRule = (function () {
      function ApplyRule(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ApplyRule.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ApplyRule(value0, value1, value2);
              };
          };
      };
      return ApplyRule;
  ...
  var up = function (v) {
      if (v.ctx instanceof L) {
          return {
              expr: new App(v.expr, v.ctx.value1),
              ctx: v.ctx.value0
          };
      };
      if (v.ctx instanceof R) {
          return {
              expr: new App(v.ctx.value0, v.expr),
              ctx: v.ctx.value1
          };
      };
      return v;
  };
  var upmost = function ($copy_v) {
      var $tco_done = false;
      var $tco_result;
      function $tco_loop(v) {
          if (v.ctx instanceof Top) {
              $tco_done = true;
              return {
                  expr: v.expr,
                  ctx: Top.value
  ...
  var showExpr = new Data_Show.Show(function (expr) {
      var go = function (v) {
          if (v.expr instanceof V) {
              return v.expr.value0;
          };
          if (v.expr instanceof App && v.ctx instanceof Top) {
              return Data_Show.show(showExpr)(v.expr.value0) + (" " + Data_Show.show(showExpr)(v.expr.value1));
          };
          if (v.expr instanceof App && v.ctx instanceof L) {
              return Data_Show.show(showExpr)(v.expr.value0) + (" " + Data_Show.show(showExpr)(v.expr.value1));
          };
          if (v.expr instanceof App) {
              return "(" + (Data_Show.show(showExpr)(v.expr.value0) + (" " + (Data_Show.show(showExpr)(v.expr.value1) + ")")));
          };
          throw new Error("Failed pattern match at Main (line 178, column 5 - line 178, column 25): " + [ v.constructor.name ]);
      };
      return go(top(expr));
  });
  var showExprHistory = new Data_Show.Show(function (v) {
      if (v instanceof One) {
          return "One " + Data_Show.show(showExpr)(v.value0);
      };
      if (v instanceof Some) {
          return "Some " + (Data_Show.show(showExpr)(v.value0) + (" " + Data_Show.show(Data_List_Types.showList(showExpr))(v.value1)));
      };
      throw new Error("Failed pattern match at Main (line 147, column 1 - line 149, column 57): " + [ v.constructor.name ]);
  });
  var showState = function (v) {
      return Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "selectedRule";
      }))(Data_Show.showRecordFieldsNil)(Data_Maybe.showMaybe(Data_Show.showString)))(Data_Show.showArray(Data_Show.showString)))(Data_Show.showArray(showExprHistory))))({
          exprs: v.exprs,
          rules: Data_Functor.map(Data_Functor.functorArray)(function (v1) {
              return v1.name;
          })(v.rules),
          selectedRule: Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
              return v1.name;
          })(v.selectedRule)
      });
  };
  var right = function (v) {
      if (v.expr instanceof App) {
          return {
              expr: v.expr.value1,
              ctx: new R(v.expr.value0, v.ctx)
          };
      };
      return v;
  };
  var pushExpr = function (e$prime) {
      return function (v) {
          if (v instanceof One) {
              return new Some(e$prime, Data_List.singleton(v.value0));
          };
          if (v instanceof Some) {
              return new Some(e$prime, new Data_List_Types.Cons(v.value0, v.value1));
          };
          throw new Error("Failed pattern match at Main (line 157, column 15 - line 159, column 35): " + [ v.constructor.name ]);
      };
  };
  var popExpr = function (v) {
      if (v instanceof One) {
          return new One(v.value0);
      };
      if (v instanceof Some && v.value1 instanceof Data_List_Types.Nil) {
          return new One(v.value0);
      };
      if (v instanceof Some && (v.value1 instanceof Data_List_Types.Cons && v.value1.value1 instanceof Data_List_Types.Nil)) {
          return new One(v.value1.value0);
      };
      if (v instanceof Some && v.value1 instanceof Data_List_Types.Cons) {
          return new Some(v.value1.value0, v.value1.value1);
      };
      throw new Error("Failed pattern match at Main (line 162, column 11 - line 166, column 35): " + [ v.constructor.name ]);
  };
  var onClickOnce = function (a) {
      return Halogen_HTML_Events.onClick(function (e) {
          return new Data_Maybe.Just(new StopPropagation(Web_UIEvent_MouseEvent.toEvent(e), a));
      });
  };
  var newExpr = One.create;
  var modifyMaybe = function (v) {
      return function (f) {
          var v1 = f(v.expr);
          if (v1 instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at Main (line 217, column 3 - line 219, column 26): " + [ v1.constructor.name ]);
      };
  };
  var left = function (v) {
      if (v.expr instanceof App) {
          return {
              expr: v.expr.value0,
              ctx: new L(v.ctx, v.expr.value1)
          };
      };
      return v;
  };
  var exampleRules = (function () {
      var id = function (v) {
          if (v instanceof App && (v.value0 instanceof V && v.value0.value0 === "id")) {
              return new Data_Maybe.Just(v.value1);
          };
          return Data_Maybe.Nothing.value;
      };
      var appendNil = function (v) {
          if (v instanceof App && (v.value0 instanceof App && (v.value0.value0 instanceof V && (v.value0.value0.value0 === "append" && (v.value0.value1 instanceof V && v.value0.value1.value0 === "Nil"))))) {
              return new Data_Maybe.Just(v.value1);
          };
          return Data_Maybe.Nothing.value;
      };
      var appendCons = function (v) {
          if (v instanceof App && (v.value0 instanceof App && (v.value0.value0 instanceof V && (v.value0.value0.value0 === "append" && (v.value0.value1 instanceof App && (v.value0.value1.value0 instanceof App && (v.value0.value1.value0.value0 instanceof V && v.value0.value1.value0.value0.value0 === "Cons"))))))) {
              return new Data_Maybe.Just(new App(new App(new V("Cons"), v.value0.value1.value0.value1), new App(new App(new V("append"), v.value0.value1.value1), v.value1)));
          };
          return Data_Maybe.Nothing.value;
      };
      return [ {
          ...
          name: "append Nil ys = ys",
          rule: appendNil
      }, {
          name: "append (Cons x xs) ys = Cons x (append xs ys)",
          rule: appendCons
      } ];
  })();
  var currentExpr = function (v) {
      if (v instanceof One) {
          return v.value0;
      };
      if (v instanceof Some) {
      ...
      throw new Error("Failed pattern match at Main (line 152, column 15 - line 154, column 16): " + [ v.constructor.name ]);
  };
  var class_ = function ($171) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($171));
  };
  var heading = function (s) {
      return Halogen_HTML_Elements.h2([ class_("title") ])([ Halogen_HTML_Core.text(s) ]);
  };
  var render = function (state) {
      var renderRule = function (selectedRule) {
          return function (rule) {
              var classes = (function () {
                  if (selectedRule instanceof Data_Maybe.Just && selectedRule.value0.name === rule.name) {
                      return [ class_("row rule active") ];
                  };
                  return [ class_("row rule") ];
              })();
              return Halogen_HTML_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(classes)([ onClickOnce(new SelectRule(rule)) ]))([ Halogen_HTML_Core.text(rule.name) ]);
          };
      };
      var renderRules = Halogen_HTML_Elements.div_([ heading("Evaluation rules"), Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderRule(state.selectedRule))(state.rules)) ]);
      var renderExpr$prime = function (i) {
          return function (loc) {
              var go = function (v) {
                  return function (v1) {
                      if (v instanceof V) {
                      ...
                      if (v instanceof App && v1 instanceof L) {
                          return [ renderExpr$prime(i)(left(loc)), renderExpr$prime(i)(right(loc)) ];
                      };
                      if (v instanceof App && v1 instanceof Top) {
                          return [ renderExpr$prime(i)(left(loc)), renderExpr$prime(i)(right(loc)) ];
                      };
                      if (v instanceof App) {
                          return [ Halogen_HTML_Core.text("("), renderExpr$prime(i)(left(loc)), renderExpr$prime(i)(right(loc)), Halogen_HTML_Core.text(")") ];
                      };
                      throw new Error("Failed pattern match at Main (line 138, column 5 - line 138, column 31): " + [ v.constructor.name, v1.constructor.name ]);
                  };
              };
              return Halogen_HTML_Elements.div([ Halogen_HTML_Events.onClick(function (e) {
                  return new Data_Maybe.Just(new ApplyRule(i, loc, Web_UIEvent_MouseEvent.toEvent(e)));
              }) ])([ Halogen_HTML_Elements.span([ class_("expr") ])(go(loc.expr)(loc.ctx)) ]);
          };
      };
      var renderExpr = function (i) {
          return function (v) {
              if (v instanceof One) {
                  return renderExpr$prime(i)(top(v.value0));
              };
              if (v instanceof Some) {
                  return Halogen_HTML_Elements.div_([ renderExpr$prime(i)(top(v.value0)), Halogen_HTML_Elements.button([ onClickOnce(new Undo(i)) ])([ Halogen_HTML_Core.text("undo") ]) ]);
              };
              throw new Error("Failed pattern match at Main (line 131, column 3 - line 131, column 66): " + [ i.constructor.name, v.constructor.name ]);
          };
      };
      var renderExprs = Halogen_HTML_Elements.div_([ heading("Expressions"), Halogen_HTML_Elements.div_(Data_Array.mapWithIndex(renderExpr)(state.exprs)) ]);
      return Halogen_HTML_Elements.div([ class_("columns") ])([ Halogen_HTML_Elements.div([ class_("column") ])([ renderRules ]), Halogen_HTML_Elements.div([ class_("column") ])([ renderExprs ]) ]);
  };
  var app = function (f) {
      return function (xs) {
          return Data_Foldable.foldl(Data_Foldable.foldableArray)(App.create)(f)(xs);
      };
  };
  var exampleExprs = [ app(new V("append"))([ app(new V("Cons"))([ new V("1"), app(new V("Cons"))([ new V("2"), new V("Nil") ]) ]), app(new V("Cons"))([ new V("3"), app(new V("Cons"))([ new V("4"), new V("Nil") ]) ]) ]), app(new V("id"))([ new V("someval") ]), app(new V("append"))([ new V("Nil"), app(new V("id"))([ new V("someval") ]) ]), app(new V("+"))([ app(new V("id"))([ new V("1") ]), app(new V("id"))([ new V("2") ]) ]) ];
  var component = function (dictMonadEffect) {
      var undoRule = function (index) {
          return function (state) {
              var v = Data_Array.modifyAt(index)(popExpr)(state.exprs);
              if (v instanceof Data_Maybe.Just) {
                  var $144 = {};
                  for (var $145 in state) {
                      if ({}.hasOwnProperty.call(state, $145)) {
                          $144[$145] = state[$145];
                      };
                  };
                  $144.exprs = v.value0;
              ...
              throw new Error("Failed pattern match at Main (line 96, column 26 - line 98, column 21): " + [ v.constructor.name ]);
          };
      };
      var selectRule = function (rule) {
          return function (state) {
              if (state.selectedRule instanceof Data_Maybe.Just && state.selectedRule.value0.name === rule.name) {
                  var $149 = {};
                  ...
                  $149.selectedRule = Data_Maybe.Nothing.value;
                  return $149;
              };
              var $153 = {};
              for (var $154 in state) {
                  if ({}.hasOwnProperty.call(state, $154)) {
                      $153[$154] = state[$154];
                  };
              };
              $153.selectedRule = new Data_Maybe.Just(rule);
              return $153;
          };
      };
      var initialState = function (v) {
          return {
              exprs: Data_Functor.map(Data_Functor.functorArray)(newExpr)(exampleExprs),
              rules: exampleRules,
              selectedRule: Data_Maybe.Nothing.value
          };
      };
      var applyRule = function (index) {
          return function (loc) {
              return function (state) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(state.selectedRule)(function (r) {
                      var v = modifyMaybe(loc)(tryRule(r));
                      if (v instanceof Data_Maybe.Just) {
                          var expr$prime = (upmost(v.value0)).expr;
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.modifyAt(index)(pushExpr(expr$prime))(state.exprs))(function (exprs$prime) {
                              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
                                  var $157 = {};
                                  for (var $158 in state) {
                                      if ({}.hasOwnProperty.call(state, $158)) {
                                          $157[$158] = state[$158];
                                      };
                                  };
                                  $157.exprs = exprs$prime;
                                  return $157;
                              })());
                          });
                      };
                      ...
                      throw new Error("Failed pattern match at Main (line 89, column 5 - line 94, column 28): " + [ v.constructor.name ]);
                  });
              };
          };
      };
      var handleAction = function (v) {
          if (v instanceof SelectRule) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(selectRule(v.value0));
          };
          if (v instanceof ApplyRule) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                  var v1 = applyRule(v.value0)(v.value1)(s);
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Web_Event_Event.stopPropagation(v.value2)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v1.value0))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          });
                      });
                  };
                  throw new Error("Failed pattern match at Main (line 65, column 7 - line 71, column 23): " + [ v1.constructor.name ]);
              });
          };
          if (v instanceof Undo) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(undoRule(v.value0));
          };
          if (v instanceof StopPropagation) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Web_Event_Event.stopPropagation(v.value0)))(function () {
                  return handleAction(v.value1);
              });
          };
          throw new Error("Failed pattern match at Main (line 59, column 18 - line 75, column 21): " + [ v.constructor.name ]);
      };
  ...
  exports["One"] = One;
  exports["Some"] = Some;
  exports["currentExpr"] = currentExpr;
  exports["pushExpr"] = pushExpr;
  exports["popExpr"] = popExpr;
  ...
  exports["top"] = top;
  exports["up"] = up;
  exports["upmost"] = upmost;
  exports["modifyMaybe"] = modifyMaybe;
  exports["tryRule"] = tryRule;
  exports["app"] = app;
  exports["exampleExprs"] = exampleExprs;
  exports["exampleRules"] = exampleRules;
  exports["class_"] = class_;
  exports["heading"] = heading;
  exports["onClickOnce"] = onClickOnce;
  exports["showExprHistory"] = showExprHistory;
